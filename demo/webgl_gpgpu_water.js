// webgl_advanced/webgl_gpgpu_water.js
...
getApp().canvas = await document.createElementAsync("canvas","webgl")
    ...
    function initWater() {
        ...
        const material = new THREE.ShaderMaterial( {
            ...
            vertexShader: onekit['waterVertexShader' ],
        ...
        heightmapVariable = gpuCompute.addVariable( 'heightmap',onekit[ 'heightmapFragmentShader' ], heightmap0 );
        ...
        smoothShader = gpuCompute.createShaderMaterial(onekit['smoothFragmentShader' ], { smoothTexture: { value: null } } );

        // Create compute shader to read water level
        readWaterLevelShader = gpuCompute.createShaderMaterial( onekit[ 'readWaterLevelFragmentShader' ], {
