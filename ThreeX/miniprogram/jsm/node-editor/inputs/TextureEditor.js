...
import { TextureNode, UVNode } from '../../nodes/Nodes.js';
const { Texture, TextureLoader, RepeatWrapping, ClampToEdgeWrapping, MirroredRepeatWrapping } = requirePlugin('ThreeX');
